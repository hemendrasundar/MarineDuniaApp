...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] layouts = new int[]{R.layout.introslide1, R.layout.introslide2, R.layout.introslider3, R.layout.introslider4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setBtnClickListener(R.id.btn_got_it);
        setBtnClickListener(R.id.btn_join);
        setBtnClickListener(R.id.btn_login);
